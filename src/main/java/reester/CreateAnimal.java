...
public class CreateAnimal {
    ...
    public Animal createAnimal(){
        ...
        if (animalName.equals("верблюд") || animalName.equals("кошка") ||  animalName.equals("собака") || animalName.equals("осел") || animalName.equals("лошадь") || animalName.equals("хомяк")) {
            ...
            System.out.println("Введите статус животного в питомнике: ");
            ...
            switch (animalName) {
                case "верблюд":
                    ...
                    System.out.println("Введите максимальную грузоподьемность верблюда: ");
                    maxCarrying = scan.nextInt();
                    System.out.println("Введите скорость предвижения верблюда: ");
                    speed = scan.nextInt();
                    ...
                    break;
                case "кошка":
                    System.out.println("Введите тип шерсти у кошки(гладкошерстная, короткошерстная, лысая): ");
                ...
                case "собака":
                    ...
                    break;
                case "осел":
                    System.out.println("Введите максимальную грузоподьемность осла: ");
                    maxCarrying = scan.nextInt();
                    System.out.println("Введите скорость предвижения осла: ");
                    speed = scan.nextInt();
                ...
                case "хомяк":
                    ...
                    break;
                case "лошадь":
                    System.out.println("Введите максимальную грузоподьемность лошади: ");
                    maxCarrying = scan.nextInt();
                    System.out.println("Введите скорость предвижения лошади: ");
                    speed = scan.nextInt();
